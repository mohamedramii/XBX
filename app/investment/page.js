...
const InvestmentPage = () => {
  ...
  return (
    <main className="w-full min-h-screen">
      ...
      <section className="relative h-[700px] w-full bg-[url('/images/investment-bg.svg')] bg-cover bg-center flex items-center justify-center 
      px-4 sm:px-8 md:px-12 lg:px-0">
        <div className="flex flex-col items-center gap-[43px] max-w-[885px] w-full px-4 text-center">
          <div className="flex flex-col items-center gap-8 w-full">
            ...
            With our innovative projects, we provide you with unique and reliable investment opportunities to achieve your financial dreams. Join hundreds of investors who have placed their trust in us            </p>
          </div>
            ...
            <div className="flex flex-col items-start gap-[40px] w-full lg:w-[693px]">
              <div className="flex flex-col items-start gap-[16px] w-full">
                ...
                <p className="font-poppins font-medium text-[22px] leading-[190%] text-[#2C3C2D]">
                  Diverse Opportunities: We offer innovative projects in promising sectors like technology, energy, and real estate.<br/><br/>
                  Guaranteed Returns: We aim to provide exceptional investment returns based on thorough studies.<br/><br/>
                  Expert Team: Our team has years of experience in managing investments and achieving success.<br/><br/>
                  Full Transparency: We provide you with all the information you need to make informed investment decisions.<br/><br/>
                  Continuous Support: Our support team is always available to assist you whenever needed.
                </p>
              </div>
              <button 
                onClick={handleExploreClick}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-[80px] w-full">
            ...
            <div className="flex flex-col items-start gap-[40px] w-full lg:w-[715px]">
              <div className="flex flex-col items-start gap-[16px] w-full">
                ...
                <p className="font-poppins font-medium text-[22px] leading-[190%] text-[#2C3C2D]">
                  Technology: Innovative projects in artificial intelligence and future technologies.<br/><br/>
                  Real Estate: Investments in strategic areas that ensure stable returns.<br/><br/>
                  Renewable Energy: Supporting sustainable projects that deliver economic and environmental benefits.<br/><br/>
                  Healthcare: Investment solutions in a rapidly growing global sector.<br/><br/>
                  Small and Medium Enterprises (SMEs): Supporting promising entrepreneurial ideas with minimal risks.
                </p>
              </div>
              <button 
                onClick={handleExploreClick}
