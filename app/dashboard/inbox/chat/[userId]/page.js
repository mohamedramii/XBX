      ...
      <div className="">
        <div className="flex flex-col items-start gap-[47px] w-[1105px]">
                  ...
                  {messages.map((msg, index) => (
                    ...
                    >
                      ...
                      <div className="flex flex-row justify-start items-center gap-[10px] absolute w-[205px] h-[30px] left-[15px] top-[15px]">
                        <span className={`font-poppins font-semibold text-[20px] leading-[30px] ${msg.isAdmin ? 'text-[#FFFFFF]' : 'text-[#11A900]'}`}>
                          @{msg.sender}
                        </span>
                        <div className={`w-0 h-[20px] border-[2px] ${msg.isAdmin ? 'border-[#FFFFFF]' : 'border-[#000000]'}`} />
                        <span className={`font-poppins font-semibold text-[20px] leading-[30px] ${msg.isAdmin ? 'text-[rgba(255,255,255,0.8)]' : 'text-[#11A900]'}`}>
                          {msg.userType}
                        </span>
                      </div>

                      {/* Timestamp */}
                      <div className="absolute w-[202px] h-[30px] left-[683px] top-[15px] font-poppins font-normal text-[20px] leading-[30px]" style={{
                      ...
                      {/* Message Text */}
                      <div className="absolute w-[860px] left-[20px] top-[65px] font-poppins font-medium text-[20px] leading-[30px]" style={{
                      ...
                      {!msg.isAdmin && (
                        <div className="absolute w-[10px] h-[10px] left-[-10px] bottom-[40px] bg-[#FFFFFF]" style={{
          ...
          <div className="flex flex-col justify-center items-start gap-[10px] w-[1105px] h-[176px] flex-none order-1 self-stretch flex-grow-0">
            {/* Input Form */}
            <form onSubmit={handleSendMessage} className="box-border flex flex-row justify-end items-center px-[20px] gap-[10px] w-[1105px] h-[97px] bg-white border-[0.5px] border-[#11A900] rounded-[50px] flex-none order-0 self-stretch flex-grow-0">
              <input
                type="text"
                value={newMessage}
