          ...
          <div className="w-full flex flex-col items-start gap-8 sm:gap-[95px]">
            ...
            <div className="w-full flex flex-col items-start gap-6 sm:gap-[71px]">
              ...
              <div className="w-full lg:w-[683px] flex flex-col items-start gap-4 sm:gap-[14px]">
                <h2 className="font-poppins font-semibold text-lg sm:text-[22px] leading-[160%] text-[#717171]">
                  description
                </h2>
            ...
            {/* Request Button */}
            <button className="w-full sm:w-[321px] h-[67px] flex justify-center items-center px-4 sm:px-[16px] py-[16px] gap-[8px] border-2 border-[#192B1A] rounded-[16px] mx-auto">
