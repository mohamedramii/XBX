...
const ServicesPage = () => {
  const services = [
    {
      title: 'design',
      description: 'Offering all design services: digital, graphic, fashion, architectural, products, and more',
    ...
    {
      title: 'marketing',
      description: 'Providing all marketing services: digital, social media, branding, advertising, and more',
      icon: '/icons/marketing.svg'
    },
    {
      title: 'Cyber security',
      description: 'Offering comprehensive cyber security services: risk assessment, threat protection, data security, and more.',
      icon: '/icons/security.svg'
    },
    {
      title: 'Artificial Intelligence',
      description: 'Offering a wide range of other services, such as consulting, support, training, and more, powered by AI solutions to achieve the best results',
      icon: '/icons/ai.svg'
    },
    {
      title: 'other services',
      description: 'Offering a wide range of other services: consulting, support, training, and more.',
  ...
  return (
    <main className="relative w-full min-h-screen">
      {/* Hero Section */}
      <section className="relative h-[700px] w-full bg-[url('/images/services-bg.svg')] bg-cover bg-center flex items-center justify-center 
      px-4 sm:px-8 md:px-12 lg:px-0">
        <div className="flex flex-col items-center gap-[43px] max-w-[885px] w-full px-4 text-center">
          <div className="flex flex-col items-center gap-8 w-full">
            ...
            "AT XBX we offer a comprehensive range of innovative services to meet your business needs. From UI/UX design and software development to integrated digital marketing solutions, we are dedicated to delivering your vision with the highest standards of quality and professionalism."            </p>
          </div>
          ...
          <div className="flex flex-col items-start gap-4 sm:gap-[16px] w-full max-w-[1249px]">
            ...
            <div className="flex flex-col items-start gap-6 sm:gap-[53px] w-full">
              <p className="w-full max-w-[1023px] font-poppins font-semibold text-[16px] sm:text-[18px] md:text-[20px] leading-[160%] text-[#192B1A]">
                We offer a comprehensive range of services in design, programming, marketing, and cybersecurity. We specialize in digital, graphic, fashion, and architectural design, along with programming solutions, digital marketing, and data protection. We also provide consulting, technical support, and training to ensure your sustained success.
              </p>
              ...
              <div className="flex flex-col justify-end items-center gap-6 w-full">
                ...
                <Link href="/services/all-services">
                  <button className="flex flex-row justify-center items-center p-3 sm:p-[12px_14px] gap-[8px] w-[100px] sm:w-[124px] border-2 border-[#192B1A] rounded-[16px]">
                    <span className="font-poppins font-bold text-[16px] sm:text-[18px] md:text-[20px] leading-[160%] text-[#0D0D0D]">see more</span>
                  </button>
                </Link>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row justify-center lg:justify-between items-start w-full max-w-[1398px] py-8 sm:py-12 lg:py-16 px-4 sm:px-8">
              ...
              <div className="flex flex-col items-start gap-[28px] w-full max-w-[669px] text-center lg:text-left">
                ...
                <p className="font-poppins font-semibold text-[16px] sm:text-[18px] md:text-[20px] leading-[160%] text-[#FBFBFB]">
                  Our team is made up of skilled professionals with extensive experience across various fields. We prioritize innovation, quality, and a deep understanding of our clients' needs, ensuring that we provide top-tier services that drive long-term success.
                </p>
                <Link href="/contact">
                  <button className="flex justify-center items-center p-3 sm:p-[12px_14px] gap-[8px] w-[100px] sm:w-[126px] border-2 border-[#FBFBFB] rounded-[16px] mx-auto lg:mx-0">
                    <span className="font-poppins font-bold text-[16px] sm:text-[18px] md:text-[20px] leading-[160%] text-[#FBFBFB]">start now</span>
                  </button>
                </Link>
              </div>
            </div>
            ...
            <div className="flex flex-col items-start p-0 gap-[24px] w-full">
              ...
              <div className="w-full font-poppins text-[16px] sm:text-[18px] md:text-[20px] leading-[160%] flex flex-col gap-6 sm:gap-8">
                <div>
                  ...
                  <p className="font-semibold text-black">Review our list of services and select the one that best suits your needs.</p>
                </div>

                <div>
                  <h3 className="font-bold text-black">Fill out the request form</h3>
                  <p className="font-semibold text-black">Complete the service or consultation request form on the website, ensuring all necessary details are provided.</p>
                </div>

                <div>
                  <h3 className="font-bold text-black">Connect with our team</h3>
                  <p className="font-semibold text-black">Once we receive your request, one of our team members will reach out to clarify service details and schedule a consultation if needed.</p>
                </div>

                <div>
                  <h3 className="font-bold text-black">Receive a customized offer</h3>
                  <p className="font-semibold text-black">Based on your requirements, a tailored offer will be provided, including all details related to the chosen service.</p>
                </div>

                <div>
                  <h3 className="font-bold text-black">Start working with the team</h3>
                  <p className="font-semibold text-black">After approving the offer, our team will begin working on delivering the requested service efficiently and professionally.</p>
                </div>

                <div>
                  <h3 className="font-bold text-black">Delivery and follow-up</h3>
                  <p className="font-semibold text-black">Once the service is completed, we will deliver the work to you and follow up to ensure your complete satisfaction.</p>
                </div>
              </div>
            </div>
            <Link href="/contact">
