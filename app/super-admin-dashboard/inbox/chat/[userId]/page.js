        ...
        <div className="flex flex-col gap-8 md:gap-12 w-full">
                  ...
                  {messages.map((msg, index) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2.5 absolute w-full md:w-[205px] h-[30px] left-4 top-4">
                        <span
                          className={`font-poppins font-semibold text-base md:text-xl leading-[30px] ${msg.isAdmin ? 'text-[#FFFFFF]' : 'text-[#11A900]'}`}
                        >
                          @{msg.sender}
                        </span>
                        <div
                          className={`hidden md:block w-0 h-5 border-[2px] ${msg.isAdmin ? 'border-[#FFFFFF]' : 'border-[#000000]'}`}
                        />
                        <span
                          className={`hidden md:block font-poppins font-semibold text-base md:text-xl leading-[30px] ${msg.isAdmin ? 'text-[rgba(255,255,255,0.8)]' : 'text-[#11A900]'}`}
                        >
                          {msg.userType}
                        </span>
                      </div>
                      ...
                      {/* Timestamp */}
                      <div
                        className="absolute text-right w-auto md:w-[202px] h-[30px] right-4 top-4 font-poppins font-normal text-sm md:text-xl leading-[30px]"
                        style={{
                      ...
                      {/* Message Text */}
                      <div
                        className="absolute w-[90%] left-4 top-16 font-poppins font-medium text-sm md:text-xl leading-relaxed md:leading-[30px]"
                        style={{
                      ...
                      {!msg.isAdmin && (
                        <div
                          className="absolute w-2.5 h-2.5 left-[-10px] bottom-[40px] bg-[#FFFFFF]"
                          style={{
          ...
          <div className="flex flex-col gap-4 w-full">
            ...
            <form
              ...
              className="flex items-center px-4 md:px-5 gap-2.5 w-full h-20 md:h-24 bg-white border border-[#11A900] rounded-[25px] md:rounded-[50px]"
            >
              <input
                type="text"
                value={newMessage}
